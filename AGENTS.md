...
- Auditoría Laws of UX 2026-09-19: producción pasa rutas, overflow, errores y axe en 320/390/768/1440. Pendientes principales: objetivos táctiles menores a 44 px en móvil y enlaces repetidos «Ver aplicación» sin nombre específico. Portada tiene canvas de globo y arcade; las pruebas del globo deben seleccionar `.atlas-canvas`.
